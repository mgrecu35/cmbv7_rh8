...
#define nbinmod_n9 __nbinmod_MOD_n9
#define nbinmod_mp_nbin_ __nbinmod_MOD_nbin
#define ran_mod_mp_normal2_ __ran_mod_MOD_normal2
#endif


#ifdef IFORT 
#define ran1() ran_mod_mp_ran1_()
#define nbinmod_n9 nbinmod_np_n9_
#endif
